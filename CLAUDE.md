...
src/
  ...
  components/
    landing-page/        # Landing page sections (hero, features, quickstart, etc.)
...
| File                                         | Purpose                                            |
| :------------------------------------------- | :------------------------------------------------- |
| `vite.config.ts`                             | Vite config (TanStack Router plugin, React, Vite+) |
| `index.html`                                 | HTML shell (fonts, meta, favicon)                  |
| `src/main.tsx`                               | App entry — router creation, React root render     |
| `src/styles.css`                             | All styles (CSS custom properties, components)     |
...
Custom skills (in `.agents/skills/`) MUST be prefixed with `_` (e.g., `_seo`). Installed skills from registries have no prefix.
